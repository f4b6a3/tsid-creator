...
public class TimeIdCreator0256Test {
	...
	@Test
	public void testOverrunException256() {

		int node = random.nextInt();
		TimestampStrategy strategy = new FixedTimestampStretegy(System.currentTimeMillis());
		TimeIdCreator creator = TsidCreator.getTimeIdCreator256(node).withTimestampStrategy(strategy);
